...
Post-setup:
:Lazy sync
:Mason  # ensure adapters (debugpy, java-debug-adapter, java-test)
Use <leader>d mappings to debug. For Python, ensure a venv or system python.
For Java, open project to attach jdtls and enable Run/Debug code lenses.
]]
